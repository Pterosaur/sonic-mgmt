...
class VMTopology(object):
    ...
    def __init__(self, vm_names, vm_properties, fp_mtu, max_fp_num, topo, worker, is_dpu=False, dut_interfaces=None, current_vm_name=None):
...
def main():
    ...
    try:
        ...
        net = VMTopology(vm_names, vm_properties, fp_mtu, max_fp_num, topo, worker, is_dpu, dut_interfaces, current_vm_name)
